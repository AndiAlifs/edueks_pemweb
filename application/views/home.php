...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <div class="container-fluid">
    ...
    <a class="navbar-brand" href="<?php echo base_url('index.php/home/index/' . $cek)?>">
      <img src="<?php echo $this->config->item('base_url'); ?>logo_tanpa_slogan.png" alt="" width="100" height="100" class="d-inline-block align-text-middle">
      Eduex
    </a>
    ...
    <div class="collapse navbar-collapse" id="navbarText">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="<?php echo base_url('index.php/home/index/' . $cek)?>">Home</a>
        </li>
        <li class="nav-item">
...
<img src="<?php echo $this->config->item('base_url'); ?>logo.png" class="img-fluid" alt="Logo Eduex" width="50" height="50">
</body>
